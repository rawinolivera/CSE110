...
if choice.lower() == 'rope':
    ...
    if choice_b.lower() == 'hide':
        ...
        if choice_b_1.lower() == 'climb':
            print("Sometimes fate surprises us, On the tree you will enjoy the view of the birds comming!")
        elif choice_b_1.lower() == 'flee':
            print("save your life looks like the best choice, but flock of birds are natural beautiful thing to see...")
        else:
            print("Your answer is not valid...") 
        ...
        if choice_b_2.lower() == 'lemonade':
            ...
            print("Water is perfect to hydrite your body!!")
        else:
            print("Your answer is not valid...") 
else:
    print("Your answer is not valid...")    
